...
var cnItems = {
    ...
    "cosmic chest": "宇宙宝箱",
    "Diplomacy Hobo": "外交游民",
    "Donates all of your cheapest currency for a paltry amount of Fame.": "捐赠你所有最便宜的货币换取微不足道的名望。",
    "Edit Hero Details": "编辑英雄详情",
    "electronic chest": "电子宝箱",
    "enhanced chest": "强化宝箱",
    "forbidden chest": "禁忌宝箱",
    "Gives you a chance to automatically donate items that are worse than your currently equipped item. 1/4 chance (independent) per rank.": "让你有机会自动捐赠比你现在装备的物品更糟糕的物品。每等级1/4机会(独立)。",
    "gold chest": "黄金宝箱",
    "gossamer chest": "游丝宝箱",
    "gothic chest": "哥特宝箱",
    "Grants a chance to gain extra treasure on each adventure. Chance is 4% + 1% per 15 ranks.": "每次冒险都有机会获得额外的宝藏。几率为每15级4% + 1%。",
    ...
    "Whenever you open a chest, you have a 7% chance per rank to open another one.": "每当你打开一个箱子，你有7%的机会打开另一个。",
